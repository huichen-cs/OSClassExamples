"""Simple model for CPU utlization"""
...
if __name__ == "__main__":
    io_wait_ratios = np.array([0.2, 0.5, 0.8])
    num_process_range = np.array(range(0, 13))
    cpu_utilization = compute_cpu_utilization(io_wait_ratios, num_process_range)
    plot_graph(cpu_utilization, io_wait_ratios, num_process_range, "multiprogramming")
