 ...
 */
public class FileCopierSioApp extends Application {
	private final static Logger LOGGER = LoggerFactory.getLogger(FileCopierSioApp.class);
	private final static String MAIN_VIEW_FXML = "view/fxml_mainview.fxml";
	private final static String APP_TITLE = "File Copier using Synchronized Blocking I/O";
