 ...
 */
public final class FileCopierSioApp extends Application {
  private static final Logger LOGGER = LoggerFactory.getLogger(FileCopierSioApp.class);
  private static final String MAIN_VIEW_FXML = "view/fxml_mainview.fxml";
  private static final String APP_TITLE = "File Copier using Synchronized Blocking I/O";
